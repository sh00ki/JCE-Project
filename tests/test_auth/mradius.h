...
#define DEFAULT_SHARED_KEY "2ZzMNRpKf574rGW"
#define REQUEST '1'
#define ACCEPT '2'
#define REJECT '3'
...
typedef struct Params {
  ...
  unsigned char username[MAX_User];
  unsigned char password[MAX];
 // unsigned char *AS_IP_Adress[MAX];
} Params;

typedef struct {
  unsigned char type;
  unsigned char length;
  unsigned char value[MAX_User];
} Attribute;
